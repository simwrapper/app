...
`;return new gt(n,{bufferLayout:t.bufferLayout,modules:[...t.modules||[],zt],defines:{...t.defines,NON_INSTANCED_MODEL:1,NUM_CHANNELS:t.channelCount},isInstanced:!1,vs:i,fs:s,topology:"point-list",disableWarnings:!0})}const kt=`uniform aggregatorTransformUniforms {
  ivec4 binIdRange;
  bvec3 isCount;
  bvec3 isMean;
  float naN;
...
`;function B([n,t],e){return[(n+(t&1)/2)*e*C,t*e*S]}const te=`
const vec2 DIST = vec2(${C}, ${S});
